      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg">
            ...
            <div class="d-sm-none d-lg-inline-block">Olá, <?php echo($_SESSION['matricula--p']); ?></div></a>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="deferir.php"><i class="ion ion-clipboard"></i><span>Pendentes</span></a>
            </li>
            <li>
              <a href="deferimentos.php"><i class="ion ion-stats-bars"></i><span>Deferimentos</span></a>
            </li>
        </aside>
      </div>